...
public class DiscountStrategyTest {
	...
	public void testSerialize_3() throws JsonGenerationException,
			JsonMappingException, IOException {
		DiscountElement element1 = new DiscountElement(0, 200, new BigDecimal(
				20.1));
		fixture.addElement(element1);
		DiscountElement element2 = new DiscountElement(201, 500,
				new BigDecimal(15.23));
		fixture.addElement(element2);
		StringWriter sw = new StringWriter();
		new ObjectMapper().writeValue(sw, fixture);
		assertEquals(
				"{\"strategy\":[{\"lower\":0,\"upper\":200,\"pct\":20.10},{\"lower\":201,\"upper\":500,\"pct\":15.23}]}",
				sw.toString());
		assertEquals("20.10", fixture.getDiscountPercentFor(30).toString());
		assertEquals("15.23", fixture.getDiscountPercentFor(300).toString());
	}
}
