...
<p>We may also track non-personal information about web pages and content accessed by visitors (see Cookies below) to the Site or the Mobile Application and the number of times such content is accessed by a specific user.  We may collect this non-personal information to improve the quality of the Site, the Mobile Application and the products and services offered through the Site or the Mobile Application.</p> 

<p>We may obtain information about your physical location, such as by use of GPS and other geolocation features in your device, or by inference from other information we collect (for example, your IP address indicates the general geographic region from which you are connecting to the Internet).</p>

<h2>To whom do we disclose personal information?</h2>

<p>In order to facilitate the placement of food orders with a caterer who is part of the Cater Request network, we will transfer all information to the caterer necessary for preparing and processing the order. On occasion, this may include transferring credit card and other payment information in cases where a restaurant, rather than Cater Request, is processing the payment. Users will need to contact restaurants directly to determine the privacy policies that apply to the information that Cater Request transfers to the restaurants.</p>
...
<h2>Cater Request Discussion Forums and Chat Rooms</h2>

<p>If you participate in a Cater Request blog, discussion forum or chat room, you should be aware that the information you provide there will be made broadly available to others, who have access to that blog, discussion forum or chat room. Also, please recognize that individual blogs, forums and chat rooms may have additional rules and conditions.  Each participant's opinion on a blog, forum or chat room is his or her own and should not be considered as reflecting the opinion of Cater Request.</p>
...
<p>Our Site, the Mobile Application and Services do not and will not target and are not intended to solicit or attract children. Cater Request does not knowingly solicit personal information from children or send them requests for personal information. For the purposes of this Policy, children means anyone under the age of 13.</p>
...
<p>We may collect non-identifiable information from visitors to the Site or the Mobile Application through the use of cookies and other technologies.  A cookie is a piece of data that a website can send to your browser, which may then be stored on your computer as an anonymous tag that identifies your computer but not you.  You can set your browser to notify you before you receive a cookie, giving you the chance to decide whether to accept it. You can also set your browser to turn off cookies. If you do so, however, some of our websites may not work properly.</p>
...
<p>You will be able to access and update the personal information that you provided when registering your account on the Site or the Mobile Application.  If you wish to obtain a copy of particular information you provided to Cater Request, or if you become aware the information is incorrect and you would like us to correct it, contact us at [info@caterrequest.com].</p>

<h2>Notification of Changes</h2>

<p>We reserve the right to amend this Policy at any time.  A notice will be posted on the homepage of the Site and to the Mobile Application for 30 days whenever this Policy is changed in a material way.  Your use of the Site, the Mobile Application or Services after the notice is posted constitute your acceptance of such changes.  Your sole and exclusive remedy if you do not agree with such changes is to cease your use of the Site, the Mobile Application and the Services. </p>
