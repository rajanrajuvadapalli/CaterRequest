         ...
         <div class="panel panel-success">
            ...
            <div class="panel-body" >
               <div class="col-lg-10 sm-5"  align="left">
                  <b>Event name:</b> ${e.name}<br /> <b>Time:</b> ${e.date_time}<br />
         ...
         <div class="panel panel-danger">
            ...
            <div class="panel-body" align="left">
               <div class="col-lg-10 sm-6">
                  <b>Restaurant Name: </b>${r.name} <br />
                  <b>Restaurant Phone Number: </b>${r.contactNumber} <br />
                  <b>Quote Price: $</b>${quote.price}  <br />
                  <b>Sales Tax: $</b>${tax} <br />
                     ...
                     <div class="panel-body" align="center" >
                        <div class="col-sm-5" >
                           ...
                           <script async="async"
                              ...
                              data-amount="${quote.price}" data-currency="USD" data-tax="${tax}"
                              data-number="${quote.id}" data-style="secondary"
