	...
	<div class="col-sm-3">
		<div class="search-cuisine-filter">
			<span
				...
				Filter</span> <br /> <br /> <span id="cuisineType_sec"></span>
		</div>
	</div>
	<div class="col-sm-9">
		<c:choose>
					...
					<div id="search-rest" class="row search-restaurant-div">
						...
						<div class="col-sm-8">
							...
							<form class="form-horizontal" method="GET"
								...
								<input type="hidden" name="rId" value="${r.restaurant.id}" /> <input
									type="hidden" name="rZip" value="${r.restaurant.address.zip}" />
